...
'''
caracter = cadena_de_texto[9]
print("caracter=>", caracter)

palabra_inicio = cadena_de_texto[     0   :    5   ]
print("palabra inicio (1)=>", palabra_inicio)

palabra_inicio = cadena_de_texto[   :    5   ]
...
texto = "Rosana"
for n in range(len(texto)): # 0, 1, 2, 3, 4, 5, ... 25
    print(texto[n])
...
texto = "Rosana María"
for n in texto: # Aquí sí recorremos la cadena de texto
    print(n)
