# ------------------------------------------------------------------------------------------
# Ordenar colecciones con funciones predefinidas por el desarrollador
# ------------------------------------------------------------------------------------------
...
bubbleSort(numbers)
print('Ordenar por Bubble Sort', numbers)

numbers = [random.randint(0, 100) * 1.1 for _ in range(20)]
numbers = quickSort(numbers)
print('Ordenar por Quick Sort', numbers)

print('-' * 90)

# ------------------------------------------------------------------------------------------
# Ordenar colecciones utilizando la función integrada 'sort'
# ------------------------------------------------------------------------------------------
