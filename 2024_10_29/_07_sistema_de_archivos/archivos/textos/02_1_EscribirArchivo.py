...
escribir_lineas('c:/datasets/curso/ejemplo_lineas_20.txt', 20)
...
'''
nombres = ['Ana', 'Pepa', 'Juan']
nombres_con_salto = [nombre + '\n' for nombre in nombres]
escribir_colecciones('c:/datasets/curso/colecciones_nombres.txt', nombres_con_salto)
