...
def crear_directorios(directorios):
    try:
        os.makedirs(directorios) # c:/datasets/curso/pruebas
    except FileExistsError as fee:
        print('El directorio ya existe')
...
def ejemplos_modulo_os():
    ...
    #obtener_archivos('c:/datasets/curso')
    # obtener_todos_archivos('c:\\datasets')
    #mostrar_archivos_completos('c:\\datasets\\curso')
    # eleminar_archivos('c:\\lucaas')
    #estado_archivos('c:/datasets/curso')
    tamanho_bytes('c:/datasets/curso')
    pass
