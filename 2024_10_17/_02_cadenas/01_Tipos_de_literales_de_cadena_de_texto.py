...
frase2 = 'Esta frase utiliza \'comillas\' simples internas'
frase2b = 'Esta frase utiliza "comillas" dobles internas'
frase3 = 'Esta frase \t\t\tcontiene tres tabuladores internos'
frase4 = "La frase tiene un salto de \nlínea interno"
carpeta = 'c:\\temp\muestra\\'
frase5 = "\u00A9 Derechos de autor"   # utf-8
frase6 = "\U0001F604 Cara Sonriente"  # utf-16
print(frase1)
print(frase2)
print(frase3)
print(frase4)
