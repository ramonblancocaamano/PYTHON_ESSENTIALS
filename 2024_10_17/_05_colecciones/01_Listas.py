...
vacia = []
elementos_arbitrarios = [5, False, 'Mia', 6+5j, [4, 'Hola']]
...
listan = [     3, 4, 5, [5, 4, [5,6,7,[5,6,7],37,67], 56, 5]      ]

print(listan[3][2][3][1])
